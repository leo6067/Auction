...
import com.leo.auction.common.callback.ClearCallBack;
...
public class SearchView extends LinearLayout {
    ...
    private ClearCallBack clearBack; // 清空
...
//                Toast.makeText(context, "返回到上一页", Toast.LENGTH_SHORT).show();
     ...
     * 点击返回后的操作，用于接口回调
     */
    public void setOnClearBack(ClearCallBack clearBack) {
