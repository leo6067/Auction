...
public class SupRuleDialog extends BaseDialog<SupRuleDialog> {
    ...
    public SupRuleDialog(Context context, String content, IButtonListener iButtonListener) {
        super(context);
    ...
    public View onCreateView() {
        ...
        View view=View.inflate(mContext, R.layout.layout_protocol_dialog_sup, null);
