 ...
 */
    ...
    public TextListAdapter(Activity context, NoticeList info) {
        mContent = context;
...
//        holder.hend.setText(info.gett"");//设置头部的文字
...
//                    如果内容显示的行数大于限定显示行数
            ...
            holder.content.setText(Html.fromHtml(info.getContent()));//用Util中的getContent方法获取内容
        }else{
