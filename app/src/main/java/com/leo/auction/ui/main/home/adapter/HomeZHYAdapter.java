...
import com.aten.compiler.base.BaseRecyclerView.BaseRecyclerViewAdapter;
...
import com.leo.auction.ui.main.home.model.HomeListModel.DataBean;
 ...
 * ================================================
 */
public class HomeZHYAdapter extends CommonAdapter<DataBean> {

    private int screenWidth;



    public HomeZHYAdapter(Context context, int screenWidth,ArrayList<DataBean> mDataList) {
        super(context,R.layout.item_home_list_all,mDataList);
        this.screenWidth = screenWidth;
    }

    @Override
    protected void convert(ViewHolder helper, DataBean item, int position) {
