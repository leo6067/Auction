...
//                holder.setTextColor(R.id.tv, Color.BLACK);
    ...
    private void getProductDetailData() {
        ...
        ReleaseEditModel.httpReleaseEditGet(productId, new HttpRequest.HttpCallback() {
            ...
            public void httpResponse(String resultData) {
                ...
                ReleaseEditModel releaseEditModel = JSONObject.parseObject(resultData, ReleaseEditModel.class);
                setPageInitData(releaseEditModel.getData());
            }
        });
    ...
    //设置页面得初始数据
    private void setPageInitData(ReleaseEditModel.DataBean info) {
