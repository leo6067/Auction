 ...
 */
public class AgentWebAppFragment extends Fragment implements FragmentKeyDown {
    ...
    public static final String TAG = AgentWebAppFragment.class.getSimpleName();
    ...
    public static AgentWebAppFragment getInstance(Bundle bundle) {
        AgentWebAppFragment mAgentWebFragment = new AgentWebAppFragment();
        if (bundle != null) {
        ...
        public void onClick(View v) {
            switch (v.getId()) {
                case R.id.iv_back:
                    ...
                    if (!mAgentWeb.back()) {
                        AgentWebAppFragment.this.getActivity().finish();
                    }
                    break;
                case R.id.iv_finish:
                    AgentWebAppFragment.this.getActivity().finish();
    ...
    private PopupMenu.OnMenuItemClickListener mOnMenuItemClickListener = new PopupMenu.OnMenuItemClickListener() {
        ...
        public boolean onMenuItemClick(MenuItem item) {
            switch (item.getItemId()) {
                ...
                case R.id.copy:
                    if (mAgentWeb != null) {
                        toCopy(AgentWebAppFragment.this.getContext(), mAgentWeb.getWebCreator().getWebView().getUrl());
                    }
                    return true;
