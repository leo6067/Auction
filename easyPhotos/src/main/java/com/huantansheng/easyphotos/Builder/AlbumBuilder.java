...
public class AlbumBuilder {
    ...
    public AlbumBuilder setOriginalMenu(boolean showOriginalMenu,boolean isChecked, boolean usable, String unusableHint) {
        Setting.showOriginalMenu = showOriginalMenu;
        Setting.selectedOriginal = isChecked;
        Setting.originalMenuUsable = usable;
        Setting.originalMenuUnusableHint = unusableHint;
        return AlbumBuilder.this;
     ...
     * @return AlbumBuilder
     */
    public AlbumBuilder isRecode(boolean bool) {
        Setting.isRecode = bool;
        return AlbumBuilder.this;
    }
     ...
     * @return
     */
    public AlbumBuilder setMaxFileSize_toast(int maxFileSize) {
        Setting.maxFileSize = maxFileSize;
        return AlbumBuilder.this;
    }
