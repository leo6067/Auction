...
public class RadiusImageView extends AppCompatImageView {
    ...
    private boolean mTopLeftCornerRadius=true;
    private boolean mTopRightCornerRadius=true;
    private boolean mBottomLeftCornerRadius=true;
    private boolean mBottomRightCornerRadius=true;
    ...
    public RadiusImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mSelectedBorderWidth = array.getDimensionPixelSize(R.styleable.QMUIRadiusImageView_qmui_selected_border_width, mBorderWidth);
        ...
        if (!mIsOval) {
            ...
            mTopLeftCornerRadius = array.getBoolean(R.styleable.QMUIRadiusImageView_qmui_topleft_corner_radius, true);
            mTopRightCornerRadius = array.getBoolean(R.styleable.QMUIRadiusImageView_qmui_topright_corner_radius, true);
            mBottomLeftCornerRadius = array.getBoolean(R.styleable.QMUIRadiusImageView_qmui_bottomleft_corner_radius, true);
            mBottomRightCornerRadius = array.getBoolean(R.styleable.QMUIRadiusImageView_qmui_bottomright_corner_radius, true);
        }
        array.recycle();
    }
        ...
        if (mIsCircle) {
            ...
            if (mIsOval) {
                ...
                if (!mTopRightCornerRadius) {
                    canvas.drawRect(mRectF.right - mCornerRadius, 0, mRectF.right, mCornerRadius, mBitmapPaint);
                }
                if (!mBottomLeftCornerRadius) {
                    canvas.drawRect(0, mRectF.bottom - mCornerRadius, mCornerRadius, mRectF.bottom, mBitmapPaint);
                }
                if (!mBottomRightCornerRadius) {
                    canvas.drawRect(mRectF.right - mCornerRadius, mRectF.bottom - mCornerRadius, mRectF.right, mRectF.bottom, mBitmapPaint);
                }
            }
        }
    }
