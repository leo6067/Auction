...
import com.aten.compiler.widget.banner.annotation.DotsAndTitleSiteMode;
import com.aten.compiler.widget.banner.annotation.PageNumViewSiteMode;
import com.aten.compiler.widget.banner.annotation.TipsSiteMode;
...
import com.aten.compiler.widget.banner.listener.OnBannerChangeListener;
import com.aten.compiler.widget.banner.listener.OnBannerClickListener;
import com.aten.compiler.widget.banner.listener.ViewPagerCurrent;
import com.aten.compiler.widget.banner.util.BannerHandlerUtils;
import com.aten.compiler.widget.banner.util.BannerSelectorUtils;
import com.aten.compiler.widget.banner.util.TransformerUtils;
...
public class BannerLayout extends FrameLayout
        ...
        BannerTipsLayout.DotsInterface,
    ...
    private int dotsSelectWidth;// dots Select width
    ...
    private int dotsBottomMargin;//The dots are marginBottom
    ...
    private void init(AttributeSet attrs) {
        ...
        dotsBottomMargin= typedArray.getInteger(R.styleable.BannerLayout_banner_dots_bottom_margin, BannerDefaults.DOTS_RIGHT_MARGIN);
        dotsWidth = (int) typedArray.getDimension(R.styleable.BannerLayout_banner_dots_width, BannerDefaults.DOTS_WIDth);
        dotsSelectWidth = (int) typedArray.getDimension(R.styleable.BannerLayout_banner_dots_select_width, BannerDefaults.DOTS_SELECT_WIDTH);
        dotsHeight = (int)typedArray.getDimension(R.styleable.BannerLayout_banner_dots_height, BannerDefaults.DOTS_HEIGHT);
    ...
    public void setTipVisibility(int visibility){
        bannerTipLayout.setVisibility(visibility);
    }
...
//        }
    ...
    @Override
    public int dotsSelectWidth() {
        return dotsSelectWidth;
    }
