package com.aten.compiler.widget.safeKeyBoard.keyboard;
...
public class SecurityKeyboard extends PopupWindow {
    ...
    private SafeBoardlistener safeBoardlistener;
    ...
    public SecurityKeyboard(final ViewGroup parentLayout, SecurityConfigure securityConfigure,SafeBoardlistener safeBoardlistener) {
        super(parentLayout.getContext());
        this.safeBoardlistener=safeBoardlistener;
        ...
        mMainView = inflater.inflate(R.layout.safe_custom_keyboard, null);
        ...
        if (DisplayUtils.dp2px(mContext, 236) > (int) (DisplayUtils.getScreenHeight(mContext) * 3.0f / 5.0f)) {
            mKeyboardLetter = new Keyboard(mContext, R.xml.gs_keyboard_english_land);
            mKeyboardNumber = new Keyboard(mContext, R.xml.gs_keyboard_number_land);
            mKeyboardSymbol = new Keyboard(mContext, R.xml.gs_keyboard_symbols_shift_land);
        } else {
            ...
            mKeyboardSymbol = new Keyboard(mContext, R.xml.gs_keyboard_symbols_shift);
        }
    ...
    private void showKeyboard(View view) {
        ...
        Animation animation = AnimationUtils.loadAnimation(mContext, R.anim.safe_board_push_bottom_in);
    ...
    public interface SafeBoardlistener{
        void boardShow();
        void boardDiss();
    }
}
