...
* 模仿支付宝支付时 加载的动画
*/
public class ZFBPayProgressBar extends View {

    private final static String TAG = ZFBPayProgressBar.class.getSimpleName();
    ...
    public ZFBPayProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    public ZFBPayProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }
