...
class BannerDefaults {
     ...
     */
    static final float DOTS_WIDth = 15f;

    /**
     * The default dotS width
     */
    static final float DOTS_SELECT_WIDTH = 20f;
    /**
     * The default dotS height
     */
    static final float DOTS_HEIGHT = 15f;
     ...
     */
    static final int GLIDE_ERROR_IMAGE =R.color.colorAccent;

    /**
     * Glide The default placeholder for the load
     */
    static final int GLIDE_PIACE_IMAGE = R.color.colorAccent;
