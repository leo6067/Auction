 ...
 *
 */
package com.aten.compiler.widget.waterMask;
...
import com.aten.compiler.widget.waterMask.bean.WatermarkImage;
import com.aten.compiler.widget.waterMask.bean.WatermarkText;
import com.aten.compiler.widget.waterMask.utils.BitmapUtils;
import java.util.List;

import static com.aten.compiler.widget.waterMask.utils.BitmapUtils.resizeBitmap;
import static com.aten.compiler.widget.waterMask.utils.BitmapUtils.textAsBitmap;
        ...
        if (watermarkImg != null && backgroundImg != null) {
            ...
            if (isTileMode) {
                ...
                watermarkCanvas.drawBitmap(scaledWMBitmap,
                        (float) watermarkImg.getPosition().getPositionX() * backgroundImg.getWidth()+80,
                        (float) watermarkImg.getPosition().getPositionY() * backgroundImg.getHeight()+80,
                        watermarkPaint);
            }
    ...
    private void createWatermarkText(WatermarkText watermarkText) {
        ...
        if (watermarkText != null && backgroundImg != null) {
            ...
            if (isTileMode) {
                ...
                watermarkCanvas.drawBitmap(scaledWMBitmap,
                        (float) watermarkText.getPosition().getPositionX() * backgroundImg.getWidth()+80,
                        (float) watermarkText.getPosition().getPositionY() * backgroundImg.getHeight()+80,
                        watermarkPaint);
            }
