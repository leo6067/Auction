...
public class ElasticZoomScrollView extends NestedScrollView {
    ...
    public ElasticZoomScrollView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public ElasticZoomScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
