...
public class SpinView02 extends AppCompatImageView implements Indeterminate {
    ...
    public SpinView02(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.spinner_wait);
        mImageResource= typedArray.getResourceId(R.styleable.spinner_wait_sw_drawble, R.drawable.kprogresshud_spinner);
        init();
    }
