package com.aten.compiler.widget.wheel.pickView;
...
public class DatePickerView extends LinearLayout implements WheelView.OnItemSelectedListener<Integer> {
    ...
    public void hideDayItem() {
        setItemVisibility(GONE,GONE, mDayWv, mDayTv);
    }
    ...
    public void showDayItem(int isshowDayLableVisibility) {
        setItemVisibility(VISIBLE,isshowDayLableVisibility, mDayWv, mDayTv);
    }
    ...
    public void showMonthItem() {
        showMonthItem(VISIBLE);
    }

    public void showMonthItem(int isshowMonthLableVisibility) {
        setItemVisibility(VISIBLE,isshowMonthLableVisibility, mMonthWv, mMonthTv);
    }
    ...
    public void showYearItem() {
        showYearItem(VISIBLE);
    }

    public void showYearItem(int isshowYearLableVisibility) {
        setItemVisibility(VISIBLE,isshowYearLableVisibility, mYearWv, mYearTv);
    }
    /**
     * 设置 item可见性
     *
    ...
    private void setItemVisibility(int visibility, WheelView wheelView, AppCompatTextView textView) {
        setItemVisibility(visibility,visibility,wheelView,textView);
    }

    /**
     * 设置 item可见性
     *
     * @param WheelViewVisibility wheelView可见性值
     * @param TextViewVisibility textView可见性值
     * @param wheelView  WheelView
     * @param textView   labelView
     */
    private void setItemVisibility(int WheelViewVisibility,int TextViewVisibility, WheelView wheelView, AppCompatTextView textView) {
        if (wheelView != null) {
            wheelView.setVisibility(WheelViewVisibility);
        }
        if (textView != null) {
