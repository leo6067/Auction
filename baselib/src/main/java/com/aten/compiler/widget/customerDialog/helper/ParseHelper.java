package com.aten.compiler.widget.customerDialog.helper;

import android.content.Context;
import android.util.Log;

import com.aten.compiler.utils.AssetUtils;
...
public class ParseHelper {
    ...
    public static final String NAME_AREA_LEVEL_3 = "Address.json";
    ...
    private static List<CityEntity> parseCityList(Context context, String assetFileName) {
        ...
        try {
            ...
            LogUtils.d(TAG,"城市列表 JSON 数据解析异常：" + e.getMessage());
        }
