...
public class DropEditText extends EditText implements AdapterView.OnItemClickListener, PopupWindow.OnDismissListener {
    ...
    private DropEditInter mDropEditInter;


    public interface   DropEditInter{

        void onItemClick(int position);
    }


    public void setDropEditInter(DropEditInter mDropEditInte){

        mDropEditInter =  mDropEditInte;
    }
    ...
    private void init(Context context) {
        ...
        mDropDrawableResId = R.drawable.down_a; // 设置下拉图标
        mRiseDrawableResID = R.drawable.up_a; // 设置上拉图标
...
//        mDrawable.setBounds(0, 0,30,30);
    ...
    public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
        ...
        mDropEditInter.onItemClick(position);
    }
