package com.aten.compiler.widget.tabLayout;
...
import com.aten.compiler.widget.tabLayout.listener.CustomTabEntity;
import com.aten.compiler.widget.tabLayout.listener.OnTabSelectListener;
import com.aten.compiler.widget.tabLayout.utils.FragmentChangeManager;
import com.aten.compiler.widget.tabLayout.utils.UnreadMsgUtils;
import com.aten.compiler.widget.tabLayout.widget.MsgView;
...
public class CommonTabLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener {
    ...
    public void notifyDataSetChanged() {
        ...
        for (int i = 0; i < mTabCount; i++) {
            ...
            } else if (mIconGravity ==90) {//代表文字不居中的情况 图片不显示的情况
                tabView = View.inflate(mContext, R.layout.layout_tab_9999, null);
            } else {
