...
public final class BarUtils {
    ...
    public static int getActionBarHeight() {
        ...
        if (RxTool.getContext().getTheme().resolveAttribute(android.R.attr.actionBarSize, tv, true)) {
            return TypedValue.complexToDimensionPixelSize(
                    tv.data, RxTool.getContext().getResources().getDisplayMetrics()
            );
        }
        return 0;
    }
    ...
    private static void invokePanels(final String methodName) {
        try {
            ...
            Object service = RxTool.getContext().getSystemService("statusbar");
    ...
    public static int getNavBarHeight() {
        Resources res = RxTool.getContext().getResources();
