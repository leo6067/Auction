package com.aten.compiler.utils.keyboard;
...
public final class KeyboardUtils {
    ...
    public static void showSoftInput(final View view) {
        InputMethodManager imm =(InputMethodManager)RxTool.getContext().getSystemService(Context.INPUT_METHOD_SERVICE);
        if (imm == null) return;
        view.setFocusable(true);
        view.setFocusableInTouchMode(true);
        view.requestFocus();
    ...
    private static int getContentViewInvisibleHeight(final Activity activity) {
        ...
        LogUtils.d("KeyboardUtils", "getContentViewInvisibleHeight: "+ (contentViewChild.getBottom() - outRect.bottom));
