...
public class OssUtils {
    ...
    public boolean sendUpFileRequest(File file,String folder,final String tag, OssCompleteListener ossCompleteListener) {
        return sendUpFileRequest(file,folder,tag,false,ossCompleteListener);
    }
    ...
    public boolean sendUpFileRequest(File file,String folder,final String tag, boolean isVideo,OssCompleteListener ossCompleteListener) {
        ...
        String fileName="";
        if (isVideo){
            fileName=folder+DateUtil.getStringDate("yyyyMMdd")+"/"+System.currentTimeMillis() + ".mp4";
        }else {
            fileName=folder+DateUtil.getStringDate("yyyyMMdd")+"/"+System.currentTimeMillis() + ".png";
        }
        // 构造上传请求
