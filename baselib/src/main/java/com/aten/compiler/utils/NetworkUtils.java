...
public final class NetworkUtils {
    ...
    public static void openWirelessSettings() {
        RxTool.getContext().startActivity(
    ...
    public static boolean getMobileDataEnabled() {
        try {
            TelephonyManager tm = (TelephonyManager) RxTool.getContext().getSystemService(Context.TELEPHONY_SERVICE);
    ...
    public static void setMobileDataEnabled(final boolean enabled) {
        try {
            TelephonyManager tm =
                    (TelephonyManager) RxTool.getContext().getSystemService(Context.TELEPHONY_SERVICE);
            if (tm == null) return;
    ...
    public static boolean getWifiEnabled() {
        ...
        WifiManager manager = (WifiManager) RxTool.getContext().getSystemService(WIFI_SERVICE);
    ...
    public static boolean isWifiConnected() {
        ConnectivityManager cm =
                (ConnectivityManager) RxTool.getContext().getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static String getIpAddressByWifi() {
        @SuppressLint("WifiManagerLeak")
        WifiManager wm = (WifiManager) RxTool.getContext().getSystemService(Context.WIFI_SERVICE);
        if (wm == null) return "";
